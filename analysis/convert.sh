...
node src/convert.js results/data.json modules/t8.html  >> results/data.csv
node src/convert.js results/data.json modules/t9.html  >> results/data.csv
node src/convert2.js results/data.json modules/t10.html >> results/data.csv
